...
file = open("./replays/moves.txt", "w")

t=0

char_flag = -1
while(char_flag==-1):
    print("Please enter the number of the character you wish to play: 1. King or 2. Archer Queen: ")
    choice = input()
    if(choice=="1"):
        char_flag = 0
    elif(choice=="2"):
...
while(1):
    ...
    if(inp=='w' or inp=='s' or inp=='a' or inp=='d'):
        ...
        for i in range(20):
            ...
            print("\n\n")
            time.sleep(1)
    # if(v1.canon_attack()!=-1):
    #     if(inp_flag==0):
    #         file.write(str(t) + "\n" + 'u' + "\n")
    # if(v1.wizard_attack()!=-1):
    #     if(inp_flag==0):
    #         file.write(str(t) + "\n" + 'u' + "\n")
    v1.canon_attack()
    v1.wizard_attack()
